...
public class CharacterController : MonoBehaviour
{
    ...
    private float currentAcidAffinity;
    private float currentElectricAffinity;
    private float currentToxicAffinity;
    ...
    void references()
    {
        ...
        currentFireAffinity = playerData.fireAffinity;
        currentAcidAffinity = playerData.acidAffinity;
        currentElectricAffinity = playerData.electricAffinity;
        currentToxicAffinity = playerData.toxicAffinity;
    }
